...
class GasPricesController :  UICollectionViewController, UICollectionViewDelegateFlowLayout{
    var Headers = "Header"
    var Cellid="Cellid"
    var Cellids="Cellids"
    var footer = "footer"
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Cellid, for: indexPath) as! GasView
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(GasView.self, forCellWithReuseIdentifier: Cellid)
    ...
    func fetcData (){
        ...
        ApiService.SharedInstance.fetchFeedForUrl(URL: "?k=\(UIDevice.current.identifierForVendor!.uuidString)&o=4&val=kjhkjhkj,3") { (Data : [[String: Any]]) in
