...
class SubCateguaryCell: BaseCell {
    
    var controller : SubCateguaryController?
    ...
    override func setupViews() {
        ...
        pointImage.widthAnchor.constraint(equalTo: widthAnchor, multiplier: 0.11 ).isActive = true
        pointImage.heightAnchor.constraint(equalTo: heightAnchor,multiplier:0.7).isActive = true
        ////////
    ...
    func SwitchToStockDetails(tapGestureRecognizer: UITapGestureRecognizer)
    {
        ...
        controller?.SwtichToStockDetails(Data: data!)
