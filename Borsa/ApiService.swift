...
class ApiService:NSObject {
    ...
    let baseUrl = NSString(format: "http://www.iqborsa.com/iqws.php")
    ...
    func fetchFeedForUrl(URL:String,completion: @escaping ([[String:Any]]) -> ()) {
            ...
            case 200:
                do {
                    ...
                    DispatchQueue.main.async (execute: {
                        ...
                        completion(getResponse as! [[String : Any]])
                    })
    ...
    func fetchFeedForObject(URL:String,completion: @escaping ([String:Any]) -> ()) {
        URLSession.shared.dataTask(with:request(URL: URL) as URLRequest , completionHandler: { (data, response, error) in
            if error != nil {
                print(error)
                return
    ...
    func fetchFeedForInt(URL:String,completion: @escaping (Int) -> ()) {
        URLSession.shared.dataTask(with:request(URL: URL) as URLRequest , completionHandler: { (data, response, error) in
            if error != nil {
                print(error)
                return
    ...
    //    func fetchFeedForUrlString(URL:String,completion: @escaping (DataComing) -> ()) {
    //        URLSession.shared.dataTask(with:request(URL: URL) as URLRequest , completionHandler: { (data, response, error) in
    //            if error != nil {
    //                print(error)
    //                return
    ...
    //                do {
    //                    let getResponse = try JSONSerialization.jsonObject(with: receivedData, options: .allowFragments)
    //                    var apparray = [DataComing]()
    //
    //
    //                    print(getResponse)
    //                    let appDetail = DataComing()
    //                    appDetail.setValuesForKeys(getResponse as! [String:AnyObject])
    //                    apparray.append(appDetail)
    //
    //                    DispatchQueue.main.async (execute: {
    ...
    //        }) .resume()
    //    }
    func Delete (URL:String,completion:@escaping ([String:AnyObject])->()){
